...
def calculate_demographic_data(print_data=True):
    ...
    # percentage of people that earn >50K in the US
    highest_earning_country = df[df["salary"] == ">50K"]["native-country"].value_counts().idxmax()
    highest_earning_country_percentage = round(df[df["salary"] == ">50K"]["native-country"].value_counts(normalize=True)[highest_earning_country] * 100, 1)
